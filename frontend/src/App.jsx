  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Driver Authentication */}
        <Route path="/driver-phone" element={<DriverPhone />} />
        <Route path="/driver-otp" element={<DriverOTP />} />
        <Route path="/driver-password" element={<DriverPassword />} />
        ...
        {/* Passenger Authentication */}
        <Route path="/passenger-phone" element={<PassengerPhone />} />
        ...
        />
        <Route path="/ride-feedback" element={<RideFeedback />} />
      </Routes>
    </BrowserRouter>
  );
}
